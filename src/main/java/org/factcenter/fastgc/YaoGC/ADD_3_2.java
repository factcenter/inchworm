...
public class ADD_3_2 extends CompositeCircuit {
	...
	public ADD_3_2(CircuitGlobals globals) {
		super(globals, 3, 2, 5, "ADD_3_2");
	}
	...
	protected void createAllSubCircuits(boolean isForGarbling) {
		...
		subCircuits[XOR2] = new XOR_2_1(globals);
		subCircuits[XOR3] = new XOR_2_1(globals);
	...
	protected void defineOutputWires() {
		 subCircuits[XOR3].outputWires[0].connectTo(outputWires, S);
		 subCircuits[XOR0].outputWires[0].connectTo(outputWires, COUT);
	}
}
