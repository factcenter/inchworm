...
/**
 * Implements a mx21 gate. If C == 0 X is returned, else Y.
 */
public class MUX_3_1 extends CompositeCircuit {
	...
	public MUX_3_1(CircuitGlobals globals) {
		super(globals, 3, 1, 3, "MUX");
	}

	@Override
	protected void createAllSubCircuits(boolean isForGarbling) {
		subCircuits[XOR0] = new XOR_2_1(globals);
		subCircuits[XOR1] = new XOR_2_1(globals);
		subCircuits[AND0] = AND_2_1.newInstance(globals, isForGarbling);
	}
	...
	protected void connectWires() {
		...
		subCircuits[XOR1].outputWires[0].connectTo(
				subCircuits[AND0].inputWires, 1);
		subCircuits[AND0].outputWires[0].connectTo(
				subCircuits[XOR0].inputWires, 1);
	}

	protected void defineOutputWires() {
		 subCircuits[XOR0].outputWires[0].connectTo(outputWires, 0);
	}

	// public int[] testCircuit(int[] inputs, String s) throws IOException {
	...
	// isCorrect = true;
	// System.out.println((isCorrect? (Color.green+"Correct") :
	// (Color.red+"Wrong")) +
	// Color.black);
	// return isCorrect;
	// }
