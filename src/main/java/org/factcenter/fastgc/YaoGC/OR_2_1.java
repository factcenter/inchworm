...
public abstract class OR_2_1 extends SimpleCircuit_2_1 {
	public OR_2_1(CircuitGlobals globals) {
		super(globals, "OR_2_1");
	}

	public static OR_2_1 newInstance(CircuitGlobals globals,
			boolean isForGarbling) {
		if (isForGarbling)
			return new G_OR_2_1(globals);
		else
			return new E_OR_2_1(globals);
	}
	...
	protected void fillTruthTable() {
		...
		lb[cL | cR] = globals.cipher.encrypt(labelL[cL], labelR[cR], k,
				BigInteger.ZERO);
