...
class MultE_GF16 extends CompositeCircuit {
	...
	public MultE_GF16(CircuitGlobals globals) {
		super(globals, 4, 4, 5, "MultE_GF16");
	}
	...
	protected void createAllSubCircuits(boolean isForGarbling) {
		...
		subCircuits[q0] = new XOR_2_1(globals);
		subCircuits[q2] = new XOR_2_1(globals);
		subCircuits[q3] = new XOR_2_1(globals);		
	}
	...
	protected void defineOutputWires() {
		 ...
		 subCircuits[A].outputWires[0].connectTo(outputWires, 1);
