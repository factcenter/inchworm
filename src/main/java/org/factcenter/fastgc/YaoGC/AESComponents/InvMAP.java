...
class InvMAP extends CompositeCircuit {
	...
	public InvMAP(CircuitGlobals globals) {
		super(globals, 8, 8, 10, "InvMAP");
	}
	...
	protected void createAllSubCircuits(boolean isForGarbling) {
		...
		subCircuits[a0] = new XOR_2_1(globals);
		subCircuits[a1] = new XOR_2_1(globals);
		subCircuits[a2] = new XOR_2_1(globals);
		subCircuits[a3] = new XOR_L_1(globals, 3);
		subCircuits[a4] = new XOR_L_1(globals, 3);
		subCircuits[a5] = new XOR_2_1(globals);
		subCircuits[a6] = new XOR_L_1(globals, 4);
		subCircuits[a7] = new XOR_L_1(globals, 3);
	...
	protected void defineOutputWires() {
		 subCircuits[a0].outputWires[0].connectTo(outputWires, 0);
		 subCircuits[a1].outputWires[0].connectTo(outputWires, 1);
		 subCircuits[a2].outputWires[0].connectTo(outputWires, 2);
		 subCircuits[a3].outputWires[0].connectTo(outputWires, 3);
		 subCircuits[a4].outputWires[0].connectTo(outputWires, 4);
		 subCircuits[a5].outputWires[0].connectTo(outputWires, 5);
		 subCircuits[a6].outputWires[0].connectTo(outputWires, 6);
		 subCircuits[a7].outputWires[0].connectTo(outputWires, 7);
	}
}