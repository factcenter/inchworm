...
class MAP extends CompositeCircuit {
	...
	public MAP(CircuitGlobals globals) {
		super(globals, 8, 8, 9, "MAP");
	}
	...
	protected void createAllSubCircuits(boolean isForGarbling) {
		...
		subCircuits[L0] = new XOR_L_1(globals, 3);
		subCircuits[L1] = new XOR_2_1(globals);
		subCircuits[L3] = new XOR_2_1(globals);
		subCircuits[H0] = new XOR_2_1(globals);
		subCircuits[H1] = new XOR_2_1(globals);
		subCircuits[H2] = new XOR_L_1(globals, 3);
	...
	protected void defineOutputWires() {
		 subCircuits[L0].outputWires[0].connectTo(outputWires, 0);
		 subCircuits[L1].outputWires[0].connectTo(outputWires, 1);
		 subCircuits[A].outputWires[0].connectTo(outputWires, 2);
		 subCircuits[L3].outputWires[0].connectTo(outputWires, 3);
		 subCircuits[H0].outputWires[0].connectTo(outputWires, 4);
		 subCircuits[H1].outputWires[0].connectTo(outputWires, 5);
		 subCircuits[H2].outputWires[0].connectTo(outputWires, 6);
		 subCircuits[B].outputWires[0].connectTo(outputWires, 7);
	}
}