...
class Mult_GF16 extends CompositeCircuit {
	...
	public Mult_GF16(CircuitGlobals globals) {
		super(globals, 8, 4, 23, "Mult_GF16");
	}

	@Override
	protected void createAllSubCircuits(boolean isForGarbling) {
		subCircuits[A] = new XOR_2_1(globals);
		subCircuits[B] = new XOR_2_1(globals);
		subCircuits[C] = new XOR_2_1(globals);
		subCircuits[q0] = new XOR_L_1(globals, 4);
		subCircuits[q1] = new XOR_L_1(globals, 4);
		subCircuits[q2] = new XOR_L_1(globals, 4);
		subCircuits[q3] = new XOR_L_1(globals, 4);

		subCircuits[and00] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and31] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and22] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and13] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and10] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andA1] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andB2] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andC3] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and20] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and11] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andA2] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andB3] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and30] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and21] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[and12] = AND_2_1.newInstance(globals, isForGarbling);
		subCircuits[andA3] = AND_2_1.newInstance(globals, isForGarbling);		
	}
	...
	protected void connectWires() {
		...
		subCircuits[and00].outputWires[0].connectTo(subCircuits[q0].inputWires,
				0);
		subCircuits[and31].outputWires[0].connectTo(subCircuits[q0].inputWires,
				1);
		subCircuits[and22].outputWires[0].connectTo(subCircuits[q0].inputWires,
				2);
		subCircuits[and13].outputWires[0].connectTo(subCircuits[q0].inputWires,
				3);

		inputWires[a1].connectTo(subCircuits[and10].inputWires, 0);
		inputWires[b0].connectTo(subCircuits[and10].inputWires, 1);

		subCircuits[A].outputWires[0].connectTo(subCircuits[andA1].inputWires,
				0);
		inputWires[b1].connectTo(subCircuits[andA1].inputWires, 1);

		subCircuits[B].outputWires[0].connectTo(subCircuits[andB2].inputWires,
				0);
		inputWires[b2].connectTo(subCircuits[andB2].inputWires, 1);

		subCircuits[C].outputWires[0].connectTo(subCircuits[andC3].inputWires,
				0);
		inputWires[b3].connectTo(subCircuits[andC3].inputWires, 1);

		subCircuits[and10].outputWires[0].connectTo(subCircuits[q1].inputWires,
				0);
		subCircuits[andA1].outputWires[0].connectTo(subCircuits[q1].inputWires,
				1);
		subCircuits[andB2].outputWires[0].connectTo(subCircuits[q1].inputWires,
				2);
		subCircuits[andC3].outputWires[0].connectTo(subCircuits[q1].inputWires,
				3);
		...
		subCircuits[A].outputWires[0].connectTo(subCircuits[andA2].inputWires,
				0);
		inputWires[b2].connectTo(subCircuits[andA2].inputWires, 1);

		subCircuits[B].outputWires[0].connectTo(subCircuits[andB3].inputWires,
				0);
		inputWires[b3].connectTo(subCircuits[andB3].inputWires, 1);

		subCircuits[and20].outputWires[0].connectTo(subCircuits[q2].inputWires,
				0);
		subCircuits[and11].outputWires[0].connectTo(subCircuits[q2].inputWires,
				1);
		subCircuits[andA2].outputWires[0].connectTo(subCircuits[q2].inputWires,
				2);
		subCircuits[andB3].outputWires[0].connectTo(subCircuits[q2].inputWires,
				3);
		...
		subCircuits[A].outputWires[0].connectTo(subCircuits[andA3].inputWires,
				0);
		inputWires[b3].connectTo(subCircuits[andA3].inputWires, 1);

		subCircuits[and30].outputWires[0].connectTo(subCircuits[q3].inputWires,
				0);
		subCircuits[and21].outputWires[0].connectTo(subCircuits[q3].inputWires,
				1);
		subCircuits[and12].outputWires[0].connectTo(subCircuits[q3].inputWires,
				2);
		subCircuits[andA3].outputWires[0].connectTo(subCircuits[q3].inputWires,
				3);
	}
