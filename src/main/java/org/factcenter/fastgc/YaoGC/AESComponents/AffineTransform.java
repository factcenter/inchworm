...
class AffineTransform extends CompositeCircuit {
	...
	public AffineTransform(CircuitGlobals globals) {
		super(globals, 8, 8, 16, "AffineTransform");
	}
	...
	protected void createAllSubCircuits(boolean isForGarbling) {
		...
		subCircuits[D] = new XOR_2_1(globals);
		subCircuits[q0] = new XOR_L_1(globals, 3);
		subCircuits[q1] = new XOR_L_1(globals, 3);
		subCircuits[q2] = new XOR_L_1(globals, 3);
		subCircuits[q3] = new XOR_L_1(globals, 3);
		subCircuits[q4] = new XOR_L_1(globals, 3);
		subCircuits[q5] = new XOR_L_1(globals, 3);
		subCircuits[q6] = new XOR_L_1(globals, 3);
		subCircuits[q7] = new XOR_L_1(globals, 3);
		subCircuits[a0bar] = new XOR_2_1(globals);
		subCircuits[a1bar] = new XOR_2_1(globals);
		subCircuits[a5bar] = new XOR_2_1(globals);
		subCircuits[a6bar] = new XOR_2_1(globals);
	...
	protected void connectWires() {
		...
		subCircuits[a0bar].outputWires[0].connectTo(subCircuits[q0].inputWires,
				0);
		...
		subCircuits[a5bar].outputWires[0].connectTo(subCircuits[q1].inputWires,
				0);
		...
		subCircuits[a1bar].outputWires[0].connectTo(subCircuits[q5].inputWires,
				0);
		...
		subCircuits[a6bar].outputWires[0].connectTo(subCircuits[q6].inputWires,
				0);
	...
	protected void defineOutputWires() {
		 ...
		 subCircuits[q4].outputWires[0].connectTo(outputWires, 4);
		 subCircuits[q5].outputWires[0].connectTo(outputWires, 5);
		 subCircuits[q6].outputWires[0].connectTo(outputWires, 6);
		 subCircuits[q7].outputWires[0].connectTo(outputWires, 7);
	}
}